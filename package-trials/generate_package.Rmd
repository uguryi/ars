...
setwd("~/repos/ars/package-trials/")
create("ars")
```
...
```{r}
file.copy("~/repos/ars/R/ars.R", "~/repos/ars/package-trials/ars/R" )
file.copy("~/repos/ars/R/auxiliary.R", "~/repos/ars/package-trials/ars/R" )
```
...
```{r}
setwd("~/repos/ars/package-trials/ars/")
document()
```
```{r}
setwd("~/repos/ars/package-trials/ars/")
